...
def create_sentence(start, size):
	sentence = []
	sentence.append(start)
	for i in range(size):
		sentence.append(most_freq_after(word_list, sentence[len(sentence)-1]))
		#sentence.append(" ")
	return sentence
...
words_to_ommit = ["has","This","had","I","you","for","or","on","from","be","at","are","it","he","as","The","was","by","is","with","which","in","the","of","to","and","a","an","another","no","the","a","an","no","another","some","any","my","our","their","her","his","its","another","each","every","certain","its","another","this","that"]

#print(word_list)

full_dict = create_dict(word_list)
cleaned_dict = ignore_words(full_dict, words_to_ommit)
...
print()
print("I think ", txtfile," is about (according to the above statistics) :")
print(summary)
...
print(create_sentence(start, 10))
